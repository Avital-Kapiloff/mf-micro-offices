	...
	if(mf_is_form_submitted()){ //if form submitted
		...
		if(!empty($error_messages)){
			...
			if(!empty($user_input['send_login'])){
				mf_send_login_info($dbh,$user_id,$user_input['user_password']);
			}

			//redirect to manage_users page and display success message
			$_SESSION['MF_SUCCESS'] = 'A new user has been added.';
							...
							<div id="au_box_user_profile" class="au_box_main gradient_blue">
								...
								<div class="au_box_content" style="padding-bottom: 15px">
									...
									<span style="display: block;margin-top: 15px">	
										...
										<img class="helpmsg" src="images/icons/68_blue.png" style="vertical-align: top" title="Checking this option will send an email to the user. The email contains their password and the login link to MachForm admin panel."/>
									</span>
