<?php
	...
	$holder_id					= htmlentities(strtolower(trim($_POST['holder_id'])));
	...
	/***************************************************************************************************************/
	switch ($element_type) {
			case 'text' 		: $element_title = 'Text';break;
			case 'textarea' 	: $element_title = 'Paragraph';break;
			case 'select' 		: $element_title = 'Drop Down';break;
			case 'radio' 		: $element_title = 'Multiple Choice';break;
			case 'checkbox' 	: $element_title = 'Checkboxes';break;
			case 'name' 		: $element_title = 'Name';break;
			case 'simple_name' 	: $element_title = 'Name';break;
			case 'date' 		: $element_title = 'Date';break;
			case 'europe_date' 	: $element_title = 'Date';break;
			case 'time' 		: $element_title = 'Time';break;
			case 'phone' 		: $element_title = 'Phone';break;
			case 'simple_phone' : $element_title = 'Phone';break;
			case 'address' 		: $element_title = 'Address';break;
			case 'money' 		: $element_title = 'Price';break;
			case 'url' 			: $element_title = 'Web Site';break;
			case 'email' 		: $element_title = 'Email';break;
			case 'number' 		: $element_title = 'Number';break;
			case 'file' 		: $element_title = 'Upload a File';break;
			case 'section' 		: $element_title = 'Section Break';break;
			case 'page_break' 	: $element_title = 'Page Break';break;
			case 'matrix' 		: $element_title = 'First Question';break;
			case 'signature' 	: $element_title = 'Draw your signature into the box below.';break;
	}
	...
	if(($action == 'click_new') || ($action == 'drag_new')){
		...
		$element_properties['submit_primary_text'] = 'Continue';
		$element_properties['submit_secondary_text'] = 'Previous';
		$element_properties['matrix_allow_multiselect'] = 0;
		$element_properties['matrix_parent_id'] = 0;
		$element_properties['section_display_in_email'] = 0;
		...
		if($element_type == 'section'){
			$element_properties['guidelines'] 	= 'This is the description of your section break.';
		}
		...
		die("Unknown action. Permission denied.");
	}
