$(function(){
	...
	//attach event to From Email dropdown
	$('#esl_from_email_address').bind('change', function() {
		if($(this).val() == 'custom'){
			$("#esl_from_email_address_custom_span").show();
		}else{
			$("#esl_from_email_address_custom_span").hide();
		}
	});
	...
	//attach event to From Email dropdown
	$('#esr_from_email_address').bind('change', function() {
		if($(this).val() == 'custom'){
			$("#esr_from_email_address_custom_span").show();
		}else{
			$("#esr_from_email_address_custom_span").hide();
		}
	});
